                                    ...
                                    <div class="flex-grow space-y-4">
                                        <div class="flex-grow">
                                            ...
                                            <div className='flex flex-row space-x-1 items-center'>
                                                ...
                                                <p class="text-blue-500 font-bold text-sm">857</p>
                                            </div>
                                        </div>
                                        <div class="flex-grow">
                                            <h2 class="text-gray-500 title-font font-bold">Total Offers</h2>
                                            <p class="text-blue-500 font-bold text-sm">58</p>
                                        </div>
                                    </div>
                                    <div class="flex-grow space-y-4">
                                        <div class="flex-grow">
                                            ...
                                            <div className='flex flex-row space-x-1 items-center'>
                                                <p class="text-blue-500 font-bold text-sm">85,904</p>
                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd"></path></svg>
                                            </div>
                                        ...
                                        <div class="flex-grow">
                                            ...
                                            <div className='flex flex-row space-x-1 items-center'>
                                                <p class="text-blue-500 font-bold text-sm">85,85958</p>
                                                <svg class="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12a1 1 0 102 0V6.414l1.293 1.293a1 1 0 001.414-1.414l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L5 6.414V12zM15 8a1 1 0 10-2 0v5.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L15 13.586V8z"></path></svg>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-grow space-y-4">
                                        <div class="flex-grow">
                                            ...
                                            <div className='flex flex-row space-x-1 items-center'>
                                                <p class="text-blue-500 font-bold text-sm">29,4049</p>
                                                <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12a1 1 0 102 0V6.414l1.293 1.293a1 1 0 001.414-1.414l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L5 6.414V12zM15 8a1 1 0 10-2 0v5.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L15 13.586V8z"></path></svg>
                                            </div>
                                        </div>
                                        <div class="flex-grow">
                                            <h2 class="text-gray-500 title-font font-bold">Earnings</h2>
                                            <div className='flex flex-row space-x-1 items-center'>
                                                <p class="text-blue-500 font-bold text-sm">99.8787</p>
                                                <svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414l-4.293 4.293a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0L11 10.586 14.586 7H12z" clip-rule="evenodd"></path></svg>
                                            </div>
                                        </div>
                                    </div>
                                </div>
