            ...
            <div className="grid grid-cols-12 gap-2">
                <div className="col-span-3">
                    <div className='col-span-4 bg-white border border-gray-200 rounded-md shadow-sm p-2 pt-1'>
                        ...
                        <ul className="py-1 h-64 bg-white shadow-sm rounded-sm sm:h-72 overflow-auto custom-scroll scrollbar">
                            {
                            ...
                            <div className='grid grid-cols-12 gap-2'>
                                <div className="col-span-4">
                                    <div className="p-2 pt-0">
                                        <div style={{ background: '#FDF1F1' }} className="h-full flex items-center justify-between p-2 px-3 rounded-lg">
                                            <div className="w-14 h-14 bg-red-200 rounded-md">
                                                <svg className="w-12 h-12 text-center py-2 mx-auto text-red-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"></path></svg>
                                            </div>
                                            <div>
                                                <h2 className="text-red-400 title-font font-bold text-right">Holden Caulfield</h2>
                                                <small className="text-red-600 font-bold text-right">This a sample demo text.</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-4">
                                    <div className="p-2 pt-0">
                                        <div style={{ background: '#EFF1FE' }} className="h-full flex items-center justify-between p-2 px-3 rounded-lg">
                                            <div className="w-14 h-14 bg-indigo-200 rounded-md">
                                                <svg className="w-12 h-12 text-center py-2 mx-auto text-indigo-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
                                            </div>
                                            <div>
                                                <h2 className="text-indigo-400 title-font font-bold text-right">Holden Caulfield</h2>
                                                <small className="text-indigo-600 font-bold text-right">This a sample demo text.</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-4">
                                    <div className="p-2 pt-0">
                                        <div style={{ background: '#FFF6F1' }} className="h-full flex items-center justify-between p-2 px-3 rounded-lg">
                                            <div className="w-14 h-14 bg-yellow-100 rounded-md">
                                                <svg className="w-12 h-12 text-center py-2 mx-auto text-yellow-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414l-4.293 4.293a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0L11 10.586 14.586 7H12z" clipRule="evenodd"></path></svg>
                                            </div>
                                            <div>
                                                <h2 className="text-yellow-400 title-font font-bold text-right">Holden Caulfield</h2>
                                                <small className="text-yellow-600 font-bold text-right">This a sample demo text.</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='col-span-8 emp-content'>
                                ...
                                <div className='grid grid-cols-12 gap-1 items-center'>
                                    <div className="col-span-6 p-2 w-full">
                                        <div className="bg-gray-100 h-full flex items-center p-2 rounded-lg">
                                            <div alt="team" className="w-12 h-12 bg-gray-300 rounded-md mr-4">
                                    ...
                                    <div className="col-span-6 p-2 pt-0 w-full mt-2">
                                        <div className="bg-gray-100 h-full flex items-center p-2 rounded-lg">
                                            <div alt="team" className="w-12 h-12 bg-gray-300 rounded-md mr-4">
                                    ...
                                    <div className="col-span-6 p-2 pt-0 w-full">
                                        <div className="bg-gray-100 h-full flex items-center p-2 rounded-lg">
                                            <div alt="team" className="w-12 h-12 bg-gray-300 rounded-md mr-4">
                            ...
                            <div className='col-span-4 create-emp-shortcut w-full mt-2'>
                                <div className='bg-white w-full rounded-md py-6 border shadow-sm border-gray-200 flex flex-col space-y-4'>
                                    <div className='content-media w-full mx-auto'>
                                        <img alt="team" className="w-24 h-20 bg-gray-100 mx-auto object-cover object-center flex-shrink-0" src="./img/addemp.svg" />
                                    </div>
                                    ...
                                    <button className="flex flex-row justify-evenly items-center w-40 rounded-md mx-auto p-2 text-sm font-bold text-white bg-indigo-500">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z"></path></svg>    Create Employee
                                    </button>
                                </div>
                            </div>
                        </div>
