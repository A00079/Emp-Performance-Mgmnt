...
const OffersTable = () => {
  return (
    <React.Fragment>
      <div class="flex pt-2">
        <input
          class="w-60 rounded p-2 border border-gray-300"
          type="text"
          placeholder="Search..."
        />
      </div>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-indigo-700">
                  <tr>
                    <th
                      scope="col"
                      class="px-6 py-2 text-left text-xs font-bold text-white capitalize tracking-wider"
                    >
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-left text-sm text-gray-500">
                      <div class="flex flex-col space-y-0">
                        ...
                        <div class="bg-gray-300 w-full rounded-sm h-2">
                          <div className="w-24 bg-indigo-600 rounded-sm h-2"></div>
                        </div>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-500">
                      <div class="flex flex-col space-y-0">
                        ...
                        <div class="bg-gray-300 w-full rounded-sm h-2">
                          <div className="w-40 bg-green-600 rounded-sm h-2"></div>
                        </div>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap font-extrabold text-xs text-gray-700">
                      <div
                        style={{ background: "#AAFFBE" }}
                        className="w-24 rounded-sm p-2 flex flex-row space-x-1 items-center"
                      >
                        <p>INR</p>
                        <p>58,8595</p>
                      </div>
                  ...
                  <tr className="bg-blue-50">
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-left text-sm text-gray-500">
                      <div class="flex flex-col space-y-0">
                        ...
                        <div class="bg-gray-300 w-full rounded-sm h-2">
                          <div className="w-20 bg-indigo-600 rounded-sm h-2"></div>
                        </div>
                        <p class="text-indigo-700 title-font font-bold text-xs">
                          40
                        </p>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-500">
                      <div class="flex flex-col space-y-0">
                        ...
                        <div class="bg-gray-300 w-full rounded-sm h-2">
                          <div className="w-24 bg-green-600 rounded-sm h-2"></div>
                        </div>
                        <p class="text-green-700 title-font font-bold text-xs">
                          70
                        </p>
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-left text-sm text-gray-500">
                      <div class="flex flex-col space-y-0">
                        ...
                        <div class="bg-gray-300 w-full rounded-sm h-2">
                          <div className="w-10 bg-indigo-600 rounded-sm h-2"></div>
                        </div>
                        <p class="text-indigo-700 title-font font-bold text-xs">
                          40
                        </p>
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-500">
                      <div class="flex flex-col space-y-0">
                        ...
                        <div class="bg-gray-300 w-full rounded-sm h-2">
                          <div className="w-10 bg-green-600 rounded-sm h-2"></div>
                        </div>
                        <p class="text-green-700 title-font font-bold text-xs">
                          70
                        </p>
