...
import { TextBox, Button, DropDown, Text } from "../../components";
  ...
  return (
    <div className="flex h-screen">
      <div className="grid grid-cols-7 w-full place-items-center">
        <div className=" absolute slanted w-full h-full col-span-3">
          <div className="absolute space-y-4 top-60">
            <div className="">
          ...
          <div className="v-align">
            <img src="/img/login.svg" width="250px" className="" />
          </div>
        </div>
        <div className="col-span-4">
          <div className="space-y-4 w-96">
            ...
            <div>
              ...
              <div style={{ color: COLORS.primary }} className="">
                <Text>New Member ? Sign-Up</Text>
              </div>
            </div>
          </div>
        </div>
