                                                ...
                                                Object.keys(el).map((itemVal, itemindex) => {
                                                    return (
                                                        itemVal.toLocaleLowerCase().includes('img') ?
                                                            <td key={itemindex} className="p-3">
                                                                <p>
                                                                    <img src={el[itemVal]} className='object-contain object-center w-20 rounded-sm'></img>
                                                                </p>
                                                            </td>
                                                            :
                                                            itemVal.toLocaleLowerCase() == 'id' ? "" :
                                                                < td key={itemindex} className="p-3" >
                                                                    <p className='w-20 truncate'>{el[itemVal]}</p>
                                                                </td>
                                                    )
                                                })
                                            }
